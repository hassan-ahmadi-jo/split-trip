...
class ParticipantExpense(models.Model):
    ...
    paid_amount = models.DecimalField(max_digits=12, decimal_places=2, verbose_name='Paid amount',  validators=[MinValueValidator(0)])
    share_amount = models.DecimalField(max_digits=12, decimal_places=2, verbose_name='Share amount',  validators=[MinValueValidator(0)])
    description = models.TextField(blank=True, verbose_name='Description')
    class Meta:
        constraints = [
            models.UniqueConstraint(
